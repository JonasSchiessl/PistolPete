...
func _ready():
	...
	var spawner = preload("res://Scenes/Level/Components/enemy_spawner.tscn").instantiate()
	add_child(spawner)
...
func _on_restart_game():
	...
	get_tree().change_scene_to_file("res://Scenes/Level/Level2/world.tscn")

func _on_return_to_menu():
	get_tree().paused = false
	get_tree().change_scene_to_file("res://Scenes/Level/Menu/main_menu.tscn")
